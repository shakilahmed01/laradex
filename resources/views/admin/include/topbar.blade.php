...
<form
    ...
    <div class="input-group">
        <input type="search" name="#0" id="searchInput" class="form-control bg-light border-0 small" placeholder="Search for..."
...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            @if($adminNotificationCount > 0)
                <p class="text-center">@lang('You have') {{ $adminNotificationCount }} @lang('unread notification')</p>
            @else
                <p class="text-center">@lang('No unread notification found')</p>
            @endif
            </h5>
            ...
            <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.notification.read',$notification->id) }}">
                ...
                <div>
                    <div class="small text-gray-500">{{ __($notification->title) }}</div>
