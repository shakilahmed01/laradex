                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-dark my-2">
                                            <h5 class="card-header bg-dark" style="color:white;">@lang('Withdraw Instruction') </h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                                                ...
                                                                <div class="card border mb-3" id="{{ $loop->index }}">
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="btn-group w-100">
                                                                            ...
                                                                            <button type="button" class="btn btn-danger removeFormData"><i class="fas fa-times"></i></button>
                                                                        </div>
                                                                    </div>
