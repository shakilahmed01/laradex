...
<div class="modal fade" data-backdrop="static" id="notificationSending">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mail-wrapper">
                    <div class= "mail-icon world-icon"><i class="fa fa-globe"></i></div>
                    <div class='mailsent'>
                        <div class='envelope'>
                    ...
                    <div class= "mail-icon mail-icon"><i class="fa fa-envelope-open-text"></i></div>
                </div>
                <div class="mt-3">
                    <div class="progress">
