                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card border--primary mt-3">
                                            <h5 class="card-header bg-primary" style="color:white;">@lang('Range')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card border-primary mt-3">
                                            <h5 class="card-header bg-primary" style="color:white;">@lang('Charge')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-primary mt-3">
                                            ...
                                            <h5 class="card-header bg-primary" style="color:white;">@lang('Deposit Instruction')</h5>
                                            <div class="card-body">
                                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-primary mt-3">
                                            <div class="card-header bg-primary d-flex justify-content-between">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-light float-end form-generate-btn"> <i class="fa fa-fw fa-plus"></i>@lang('Add New')</button>
                                            </div>
                                            <div class="card-body">
                                                                ...
                                                                <div class="card border mb-3" id="{{ $loop->index }}">
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="btn-group w-100">
                                                                            <button type="button" class="btn btn-primary editFormData" data-form_item="{{ $jsonData }}" data-update_id="{{ $loop->index }}"><i class="fas fa-pen"></i></button>
                                                                            <button type="button" class="btn btn-danger removeFormData"><i class="fa fa-times"></i></button>
                                                                        </div>
                                                                    </div>
