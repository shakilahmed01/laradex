                                ...
                                <div class="payment-method-item block-item child-item">
                                    ...
                                    <div class="payment-method-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border-primary mt-2">
                                                    <h5 class="card-header bg-primary" style="color:white;">@lang('Currency')</h5>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
    ...
    <script>
        (function ($) {
            ...
            $('.newCurrencyBtn').on('click', function () {
                ...
                var getCurrencySelected = $('.form-control').find(':selected').val();
                var currency = $(this).data('crypto') == 1 ? 'USD' : `${getCurrencySelected}`;
                if (!getCurrencySelected) return;
                form.find('input').removeAttr('disabled');
                var symbol = $('.form-control').find(':selected').data('symbol');
