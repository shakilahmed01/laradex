class FormGenerator{
    ...
    extraFields(fieldType){
        ...
        if (this.fieldType == 'file') {
            ...
            addNew = `<button type="button" class="btn btn-sm btn-primary addOption"><i class="fas fa-plus me-0"></i></button>`;
        ...
        return `
            <div class="form-group">
                <div class="input-group">
                    ...
                    <button type="button" class="btn btn-danger input-group-text removeOption"><i class="fas fa-times"></i></button>
                </div>
            </div>
        `;
    }
        ...
        var formsHtml = `
            ...
            <div class="card-body">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn btn-primary editFormData" data-form_item='${JSON.stringify(formItem)}' data-update_id="${updateId}"><i class="fas fa-pen"></i></button>
            ...
            if (i==0) {
                html += `
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <button type="button" class="btn btn-sm btn-primary addOption"><i class="fas fa-plus me-0"></i></button>
                    </div>
                `;
            }
            i += 1;
